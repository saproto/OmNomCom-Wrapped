<template>
  <div class="slide">
    <h1>The product you loved most this year was</h1>
    <div class="product-card" style="height: 10em;">
    ...
    <h3>That puts you in the top {{ stats.percentile }}% buyers of this product.</h3>
...
.product-card {
  ...
  align-items: center;
  gap: 1em;
  box-shadow: rgba(255,255,255,.2) 0 0 10px 10px;
}
